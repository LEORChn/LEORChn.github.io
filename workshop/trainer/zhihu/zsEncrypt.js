 ...
 * note: 反正就是能运行，我也不知道他具体内部是怎么运行的。
 */

(function(){
	var exports = {}
	function t(e) {
		return (t = "function" == typeof Symbol && "symbol" == typeof Symbol.A ?
			function(e) {
				return typeof e
			}:
			function(e) {
	...
	var desc = 'zsEncrypt // 2021-4-29 // x-zse-83: 3_2.0';
	window.zsEncrypt = function(e){
		return e? __g._encrypt(encodeURIComponent(e)): desc
	};
	window.zsEncrypt.toString = function(){ return desc };
})();
