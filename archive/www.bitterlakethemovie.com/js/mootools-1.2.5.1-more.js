...
this.each(function(c,b){if($type(c)=="function"){c.run(a);}});}});(function(){var c={a:"[идивa?????]",A:"[идив??????]",c:"[???]",C:"[???]",d:"[??]",D:"[?D]",e:"[ииижи║?из?]",E:"[ииижи║?из?]",g:"[?]",G:"[?]",i:"[имик??]",I:"[имик??]",l:"[???]",L:"[???]",n:"[?и╛и╜]",N:"[???]",o:"[и░ио?????]",O:"[и░ио????]",r:"[??]",R:"[??]",s:"[???]",S:"[???]",t:"[??]",T:"[??]",ue:"[и╣]",UE:"[и╣]",u:"[и┤и▓??ж╠]",U:"[и┤и▓??]",y:"[?y]",Y:"[?Y]",z:"[???]",Z:"[???]",th:"[t]",TH:"[T]",dh:"[e]",DH:"[D]",ss:"[?]",oe:"[?]",OE:"[?]",ae:"[?]",AE:"[?]"},b={" ":"[\xa0\u2002\u2003\u2009]","*":"[\xb7]","'":"[\u2018\u2019]",'"':"[\u201c\u201d]","...":"[\u2026]","-":"[\u2013]","--":"[\u2014]","&raquo;":"[\uFFFD]"};
...
/*
     FILE ARCHIVED ON 16:37:58 Feb 10, 2012 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  LoadShardBlock: 136.847 (3)
  esindex: 0.007
  captures_list: 150.849
  CDXLines.iter: 10.996 (3)
  PetaboxLoader3.datanode: 156.986 (4)
  exclusion.robots: 0.145
  exclusion.robots.policy: 0.134
  RedisCDXSource: 0.573
  PetaboxLoader3.resolve: 19.77
